								...
								<div class="col-md-12">
									<div class="row">
										<div class="form-group">
											...
											<div class="col-md-9">
												<input type="text" class="form-control" id="fname" name="fname" value="<?php echo !empty($user['fname']) ? htmlentities($user['fname'],ENT_QUOTES,'UTF-8',FALSE) : '' ?>" <?php echo !$permissions['modifyUser'] ? 'disabled' : ''?>>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-md-12">
									<div class="row">
										<div class="form-group">
											...
											<div class="col-md-9">
												<input type="text" class="form-control" id="lname" name="lname" value="<?php echo !empty($user['lname']) ? htmlentities($user['lname'],ENT_QUOTES,'UTF-8',FALSE) : ''; ?>" <?php echo !$permissions['modifyUser'] ? 'disabled' : ''?>>
											</div>
										</div>
									</div>
								</div>
