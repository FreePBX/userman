			...
			<div class="col-md-12">
				<div class="row">
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" id="emailsubject" name="emailsubject" value="<?php echo !empty($emailsubject) ? $emailsubject : _("Your %brand% Account")?>" tabindex="<?php echo ++$tabindex;?>">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-12">
				<div class="row">
					<div class="form-group">
						...
						<div class="col-md-9">
							<textarea class="form-control" id="emailbody" name="emailbody" rows="15" cols="80" tabindex="<?php echo ++$tabindex;?>"><?php echo !empty($emailbody) ? $emailbody : file_get_contents(__DIR__.'/emails/welcome_text.tpl')?></textarea>
						</div>
					</div>
				</div>
			</div>
