...
/*Generate a User for Template creation,view/edit */
	public function generateTemplateCreator(){
		...
		$ret = $this->addUserByDirectory($directory['id'], $this->getUserNameTemplateCreator(), $password, $unusedexten, _('Autogenerated user For Template Creation'), array('email' => $email, 'displayname' => $this->displayNameTemplateCreator));
		if($ret['status']) {
