...
class Userman extends \FreePBX_Helpers implements \BMO {
	...
	public function install() {
		 ...
		 */
		$table = $this->FreePBX->Database->migrate("userman_users");
		$cols = array (
			'id' => array (
				'type' => 'integer',
				'primaryKey' => true,
		...
		$table = $this->FreePBX->Database->migrate("userman_groups");
		$cols = array (
			'id' => array (
				'type' => 'integer',
				'primaryKey' => true,
		...
		$table = $this->FreePBX->Database->migrate("userman_directories");
		$cols = array (
			'id' => array (
				'type' => 'integer',
				'primaryKey' => true,
